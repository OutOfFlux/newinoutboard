...
const employees = [
  ...
  { name: 'Diana Chen', department: 'Engineering', status: 'Working from Home', comment: 'Available on Slack', estimated_return: '' },
  ...
  { name: 'Greg Tanaka', department: 'Engineering', status: 'Lunch', comment: '', estimated_return: '1:00 PM' },
  ...
  { name: 'Kevin Brooks', department: 'Sales', status: 'Break', comment: '', estimated_return: '' },
  ...
  { name: 'Quinn Murphy', department: 'Operations', status: 'Lunch', comment: '', estimated_return: '12:30 PM' },
  ...
  { name: 'Tina Gonzalez', department: 'Operations', status: 'Working from Home', comment: 'Reachable by email', estimated_return: '' },
];
